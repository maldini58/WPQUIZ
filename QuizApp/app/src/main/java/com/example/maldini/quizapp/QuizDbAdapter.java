...
public class QuizDbAdapter {
    ...
    public static final String WRONG_QUESTION_NUMBER= "wrong question number";
    public static final String CORRECT_QUESTION_NUMBER = "correct question number";
    public static final String ANSWERED_QUESTION_NUMBER = "answered question number";
    ...
    public long insertQuiz(ContentValues initialValues){
        return mDb.insertWithOnConflict(QUIZ_TABLE,null,initialValues,SQLiteDatabase.CONFLICT_IGNORE);
    }

    public boolean updateQuiz(int id, ContentValues newValues){
        String[] selectionArgs = {String.valueOf(id)};
        return mDb.update(QUIZ_TABLE,newValues,KEY_ROWID + "=?",selectionArgs) > 0;
    }

    public boolean deleteQuiz(int id){
        String[] selectionArgs = {String.valueOf(id)};
        return mDb.delete(QUIZ_TABLE, KEY_ROWID + "=?", selectionArgs) > 0;
    }
    ...
    public static Quiz getQuizFromCursor(Cursor cursor){
        Quiz quiz = new Quiz();
